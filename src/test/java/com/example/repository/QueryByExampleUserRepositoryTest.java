...
@SpringBootTest
public class QueryByExampleUserRepositoryTest {
    ...
    public void logAllMailRuUsers() {
        // Probe
        User probeUser = new User();
        probeUser.setEmail("mail.ru");

        // ExampleMatcher
        ExampleMatcher mailRuMatcher = ExampleMatcher.matchingAll()
                .withStringMatcher(ExampleMatcher.StringMatcher.ENDING);
        Example<User> example = Example.of(probeUser, mailRuMatcher);
